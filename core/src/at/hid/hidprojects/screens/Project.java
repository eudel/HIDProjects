...
public class Project implements Screen {
	...
	private Skin skin;
	private Table table, table0, table1;
	...
	public void show() {
		...
		new Label(HIDProjects.getLangBundle().format("MainMenu.lblProfile.text"), skin);
		new Label(HIDProjects.getLangBundle().format("MainMenu.lblInfo.text") + " " + HIDProjects.profile.getDisplayName() + "\n", skin);
